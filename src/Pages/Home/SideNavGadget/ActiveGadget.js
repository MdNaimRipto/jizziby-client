            ...
            <div className='overflow-scroll lg:overflow-hidden'>
                <div className="4 mx-auto container" data-aos="fade-left">
                    <div className='flex justify-between items-end mt-2'>
                        ...
                        <Link to="/drones" className='text-base hidden lg:block hover:text-lg hover:text-primary duration-300 font-semibold border-b border-b-primary'>
                            View All
                        </Link>
                    </div>
                    <div className='flex justify-between items-end mt-2'>
                        <label htmlFor="my-drawer-3" className="flex items-center border-b border-b-[#ffbb38] font-semibold text-left drawer-button lg:hidden w-2/5 md:w-1/5">
                            View List
                            <MdArrowForwardIos className='text-sm' />
                        </label>
                        <Link to="/drones" className='text-base block lg:hidden hover:text-lg hover:text-primary duration-300 font-semibold border-b border-b-primary'>
                            View All
                        </Link>
                    </div>
