            ...
            <div className='overflow-scroll lg:overflow-hidden'>
                <div className="4 mx-auto container" data-aos="fade-left">
                    <div className='flex justify-between items-end mt-2'>
                        ...
                        <Link to="/consoles" className='text-base hidden lg:block hover:text-lg hover:text-primary duration-300 font-semibold border-b border-b-primary'>
                            View All
                        </Link>
                    </div>
                    <div className='flex justify-between items-end mt-2'>
                        ...
                        <Link to="/consoles" className='text-base block lg:hidden hover:text-lg hover:text-primary duration-300 font-semibold border-b border-b-primary'>
                            View All
                        </Link>
                    </div>
