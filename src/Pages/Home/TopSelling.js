                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12 mx-12 mt-8' data-aos="fade-right">
                    {
                        topSelling.map(product => (
                            <div className="bg-white rounded-lg shadow-md p-6 lg:flex items-center"
                                key={product._id}>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        <h3 className="text-lg font-medium mr-2">TK.{product.price}</h3>
                                        <Link to={`/${product.category}/${product._id}`}
                                            className="bg-primary text-white py-2 px-4 rounded-lg hover:text-black duration-300"
                                        >View Details
                                        </Link>
                                    </div>
                                </div>
